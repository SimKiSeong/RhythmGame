 ...
 */
   public Menu() {
      ...
      trackList.add(new Track("someTitle.png", "some Bolbbalgan4 image.jpg", "Bolbbagan4Startimage.png", "SomeSelected.mp3", "Seo.mp3")); // 타占쏙옙틀占싱뱄옙占쏙옙, 占쌕뱄옙占싱뱄옙占쏙옙, 占쏙옙占쏙옙占싱뱄옙占쏙옙, 占쏙옙占쏙옙 占쎈래, 占쏙옙체占쎈래
      ...
      menuBar.addMouseListener(new MouseAdapter() {
          ...
          * @param int mouseX 마우스가 위치한 x좌표
          * @param int mouseY 마우스가 위치한 y좌표
          */
         @Override
       ...
       * @param int x 전체 프레임을 이동시킬 x좌표
       * @param int y 전체 프레임을 이동시킬 y좌표
       */
